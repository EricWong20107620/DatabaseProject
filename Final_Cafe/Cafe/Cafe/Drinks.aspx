<%@ Page Title="Drinks" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Drinks.aspx.cs" Inherits="Cafe.Drinks" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table border="1" style="width:90px;background-color:#e0ebeb">
        ...
        <tr>
            <td><center><b><asp:Label ID="lblfilterTemperature" runat="server" Text="Temperature" Width="90px"></asp:Label></b></center></td>
            <td>
                <asp:DropDownList ID="ddlTemperature" runat="server" Width="90px" AppendDataBoundItems="true" DataTextField="temperature" DataValueField="temperature">
                    <asp:ListItem Text="ALL" Value="%" />
                </asp:DropDownList>
            </td>
        </tr>
    ...
    <asp:DataList ID="DrinkList" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" Width="100%" OnItemCommand="DrinkList_ItemCommand">
        <ItemTemplate>
            <br />
                ...
                <table border="1" style="width:460px;background-color:#e0ebeb">
                    ...
                    <tr>
                        ...
                        <td><center><asp:Label ID="lblItem2" runat="server" Text='<%# Eval("drink_name") %>'></asp:Label></center></td>
                    </tr>
                    <tr>

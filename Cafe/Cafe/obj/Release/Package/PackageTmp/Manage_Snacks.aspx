<%@ Page Title="Manage Snacks" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage_Snacks.aspx.cs" Inherits="Cafe.Manage_Snacks" %>
        ...
        <tr>
            <td style="width:50%">
                ...
                <table style="width:100%;background-color:#e0ebeb">
                    <tr>
                        <td style="width:50%"><center><b><asp:Label ID="lblFoodName" runat="server" Text="Snack Name"></asp:Label></b></center></td>
                ...
                <asp:Panel ID="pData" runat="server" Height="300px" ScrollBars="Vertical" Width="95%">
                    <asp:DataList ID="ManageSnackList" runat="server" Width="100%" OnItemCommand="ManageSnackList_ItemCommand">
                        <ItemTemplate>
                        <asp:HiddenField ID="hfID" runat="server" Value='<%# Eval("snack_id") %>'/>
                        <table style="width:100%">
                            <tr>
                                <td style="width:50%"><center><asp:Label ID="lblFoodName2" runat="server" Text='<%# Eval("snack_name") %>'></asp:Label></center></td>
            ...
            <td style="width:50%">
                <table border="1" style="width:100%;background-color:#e0ebeb">
                    ...
                    <tr>
                        <td style="width:50%"><center><b><asp:Label ID="lblFoodID" runat="server" Text="Snack ID"></asp:Label></b></center></td>
                        <td style="width:50%" colspan="3"><asp:TextBox ID="txtFoodID" runat="server" Enabled="false" Width="100%"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td><center><b><asp:Label ID="lblFoodName3" runat="server" Text="Snack Name"></asp:Label></b></center></td>
